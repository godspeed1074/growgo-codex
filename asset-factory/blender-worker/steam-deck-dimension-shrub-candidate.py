...
adjust="""\n# Targeted bounded dimension/planter correction candidate.\nroots['FASCIA'].scale.x*=1.05;roots['AWNING'].scale.x*=1.05;roots['DOOR'].scale.x*=1.04;roots['WINDOW'].scale.x*=1.03;roots['SHRUB'].scale.x*=1.05;roots['SHRUB'].scale.z*=1.04;roots['SHRUB'].location.x-=.04\n"""
text=text.replace('s=bpy.context.scene;',adjust+'\ns=bpy.context.scene;')
