...
export function executeBlenderCorrection({ blenderExecutable, plan, sourcePath, resultPath, renderPath, cameraName, protectedObjectIds = [], outputRoot = path.dirname(resultPath) }) {
