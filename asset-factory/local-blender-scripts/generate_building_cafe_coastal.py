"""
GrowGo controlled assembly-test generator for BUILDING_CAFE_COASTAL_001.

This script is intended to be executed locally with Blender Python.
It assembles the approved coastal cafe recipe by reusing registered coastal
Layer A exports plus the validated hospitality module batch.
"""
...
ASSET_ID = "BUILDING_CAFE_COASTAL_001"
RECIPE_ID = "RECIPE_CAFE_COASTAL_001"
FAMILY_ID = "FAMILY_COMMERCIAL_COASTAL"

OUTPUT_DEFAULT = "/Users/michaelpeterson/Documents/Codex/2026-06-16/files-mentioned-by-the-user-root/growgo-codex/asset-factory-workspace/production/CAFE_COASTAL_FAMILY_001/export"
...
METADATA_OUTPUT = "building-cafe-coastal-metadata.json"
MANIFEST_OUTPUT = "building-cafe-coastal-manifest.json"
VALIDATION_OUTPUT = "building-cafe-coastal-validation.json"
...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="Assemble BUILDING_CAFE_COASTAL_001 from approved Layer A exports."
    )
...
def create_entry_portal(collection, lod_key, parent):
    portal = bpy.data.objects.new(f"CAFE_ENTRY_PORTAL_{lod_key.upper()}", None)
    collection.objects.link(portal)
    portal.location = (0.0, -2.55, 0.92)
...
def write_metadata(output_dir):
    manifest = {
        ...
        "hospitalityModulesUsed": HOSPITALITY_MODULES_USED,
        "expectedOutputs": LOD_OUTPUTS,
    }
    metadata = {
        "assetId": ASSET_ID,
        "recipeId": RECIPE_ID,
        "moduleList": REUSED_MODULES + HOSPITALITY_MODULES_USED,
    ...
    validation = {
        ...
        "hospitalityModuleCount": len(HOSPITALITY_MODULES_USED),
        "totalModuleCount": len(REUSED_MODULES) + len(HOSPITALITY_MODULES_USED),
        "reusePercentage": TARGET_REUSE_PERCENTAGE,
    }
