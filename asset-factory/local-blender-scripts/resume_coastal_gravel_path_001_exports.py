"""
Manual Blender 4.2 LTS export-resume workflow for COASTAL_GRAVEL_PATH_001_v001.

Run only after manually inspecting and saving COASTAL_GRAVEL_PATH_001_v001.blend.
...
BOOTSTRAP_STATE = growgo_blender_bootstrap.bootstrap_local_blender_scripts(
    "resume_coastal_gravel_path_001_exports.py",
...
EXPORT_START = "S198_2_COASTAL_GRAVEL_PATH_EXPORT_START"
EXPORT_COMPLETE = "S198_2_COASTAL_GRAVEL_PATH_EXPORT_COMPLETE"
EXPORT_FAILURE_PREFIX = "S198_2_COASTAL_GRAVEL_PATH_EXPORT_FAILURE:"
...
def main():
    ...
    write_export_manifest(
        EXPECTED_EXPORT_DIR / "coastal-gravel-path-export-manifest.json",
        asset_id=ASSET_ID,
        recipe_id=SOURCE_RECIPE_ID,
