"""
Manual Blender 4.2 LTS export-resume workflow for COASTAL_GROUND_COVER_001_v002.

Run only after manually inspecting and saving COASTAL_GROUND_COVER_001_v002.blend.
...
EXPORT_START = "S195_3_COASTAL_GROUND_COVER_V002_EXPORT_START"
EXPORT_COMPLETE = "S195_3_COASTAL_GROUND_COVER_V002_EXPORT_COMPLETE"
EXPORT_FAILURE_PREFIX = "S195_3_COASTAL_GROUND_COVER_V002_EXPORT_FAILURE:"
...
def main():
    ...
    write_export_manifest(
        EXPECTED_EXPORT_DIR / f"coastal-ground-cover-{ASSET_VERSION}-export-manifest.json",
        asset_id=ASSET_ID,
        recipe_id=SOURCE_RECIPE_ID,
