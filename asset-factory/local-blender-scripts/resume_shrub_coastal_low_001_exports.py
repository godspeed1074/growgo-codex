"""
Manual Blender 4.2 LTS export-resume workflow for SHRUB_COASTAL_LOW_001_v001.
...
EXPECTED_BLEND_NAME = "SHRUB_COASTAL_LOW_001_v001.blend"
DEPENDENCY_IDS = (
...
def main():
    ...
    write_export_manifest(
        EXPECTED_OUTPUT_DIR / "shrub-coastal-low-export-manifest.json",
        asset_id=ASSET_ID,
        recipe_id=SOURCE_RECIPE_ID,
