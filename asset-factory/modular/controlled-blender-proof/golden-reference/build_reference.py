...
objs.append(cube('GG_BLD_AWNING_SHOP_001','AWNING','GG-BLD-AWNING-SHOP-001','1.0.0','SHOP_AWNING',(2.2,1.0,.35),(0,-.7,2.55),'AWNING'))
...
scene.render.filepath="/Users/michaelpeterson/.codex/.chatgpt-projects/g-p-6863f0a29ae08191b7d09cf52fb8aa46/growgo-codex/asset-factory/modular/controlled-blender-proof/golden-reference/CONTROLLED_GOLDEN_REFERENCE.png"
bpy.ops.wm.save_as_mainfile(filepath="/Users/michaelpeterson/.codex/.chatgpt-projects/g-p-6863f0a29ae08191b7d09cf52fb8aa46/growgo-codex/asset-factory/modular/controlled-blender-proof/golden-reference/REFERENCE_SOURCE.blend"); bpy.ops.render.render(write_still=True)
...
stats['fileSizeBytes']=__import__('os').path.getsize("/Users/michaelpeterson/.codex/.chatgpt-projects/g-p-6863f0a29ae08191b7d09cf52fb8aa46/growgo-codex/asset-factory/modular/controlled-blender-proof/golden-reference/REFERENCE_SOURCE.blend")
with open("/Users/michaelpeterson/.codex/.chatgpt-projects/g-p-6863f0a29ae08191b7d09cf52fb8aa46/growgo-codex/asset-factory/modular/controlled-blender-proof/golden-reference/BLENDER_REFERENCE_STATS.json",'w') as f: json.dump(stats,f,indent=2)
