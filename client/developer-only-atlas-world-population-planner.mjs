...
export function createDeveloperOnlyAtlasWorldPopulationPlanner({
  ...
  const atlasBatchOrchestrationAuditTrailsStatus =
    getDeveloperOnlyAtlasBatchOrchestrationAuditTrailsStatus(
      atlasBatchOrchestrationAuditTrails
    );
  ...
  const state = {
    ...
    atlasAssetFactoryPackageManifestsVersion:
      atlasAssetFactoryPackageManifestsStatus
        .atlasAssetFactoryPackageManifestsVersion,
    registeredAssetFactoryManifestRuleCount:
      atlasAssetFactoryPackageManifestsStatus
        .registeredAssetFactoryManifestRuleCount,
    assetPackageManifestId:
      atlasAssetFactoryPackageManifestsStatus.assetPackageManifestId,
    exportValidationProfileId:
      atlasAssetFactoryPackageManifestsStatus.exportValidationProfileId,
    manifestComponentCount:
      atlasAssetFactoryPackageManifestsStatus.manifestComponentCount,
    ...
    atlasFactoryValidationGatesVersion:
      atlasFactoryValidationGatesStatus.atlasFactoryValidationGatesVersion,
    registeredFactoryValidationGateRuleCount:
      atlasFactoryValidationGatesStatus
        .registeredFactoryValidationGateRuleCount,
    productionReadinessProfileId:
      atlasFactoryValidationGatesStatus.productionReadinessProfileId,
    factoryValidationStatus:
      atlasFactoryValidationGatesStatus.factoryValidationStatus,
    validationGateCount: atlasFactoryValidationGatesStatus.validationGateCount,
    ...
    atlasBatchOrchestrationAuditTrailsVersion:
      atlasBatchOrchestrationAuditTrailsStatus
        .atlasBatchOrchestrationAuditTrailsVersion,
    registeredBatchOrchestrationRuleCount:
      atlasBatchOrchestrationAuditTrailsStatus
        .registeredBatchOrchestrationRuleCount,
    productionBatchId:
      atlasBatchOrchestrationAuditTrailsStatus.productionBatchId,
    auditTrailId: atlasBatchOrchestrationAuditTrailsStatus.auditTrailId,
    batchAssetCount:
      atlasBatchOrchestrationAuditTrailsStatus.batchAssetCount,
    batchDependencyCount:
      atlasBatchOrchestrationAuditTrailsStatus.batchDependencyCount,
    orchestrationReason:
      atlasBatchOrchestrationAuditTrailsStatus.orchestrationReason,
...
export function createDeveloperOnlyAtlasWorldPopulationPlan(planner, input = {}) {
  ...
  state.assetPackageManifestId = null;
  state.exportValidationProfileId = null;
  ...
  state.productionReadinessProfileId = null;
  state.factoryValidationStatus = null;
  ...
  state.productionBatchId = null;
  state.auditTrailId = null;
  state.batchAssetCount = 0;
  state.batchDependencyCount = 0;
  state.orchestrationReason = null;
  ...
  const batchOrchestrationAuditTrailDecisions = [];
  ...
  for (const feature of truncatedFeatures) {
    ...
    const assetFactoryManifestResolution =
      ...
      attachmentMetadataResolution.attachmentMetadataProfileId
        ? resolveDeveloperOnlyAtlasAssetFactoryPackageManifest(
            internal.atlasAssetFactoryPackageManifests,
            {
    ...
    const batchOrchestrationAuditTrailResolution =
      ...
      productionBundleJobTicketResolution.assetJobTicketId
        ...
        : {
            ...
            orchestrationReason:
              "BATCH_ORCHESTRATION_AUDIT_TRAIL_UNAVAILABLE"
          };
    ...
    state.assetPackageManifestId =
      assetFactoryManifestResolution.assetPackageManifestId;
    state.exportValidationProfileId =
      assetFactoryManifestResolution.exportValidationProfileId;
    state.manifestComponentCount =
      assetFactoryManifestResolution.manifestComponentCount;
    ...
    state.productionReadinessProfileId =
      factoryValidationGateResolution.productionReadinessProfileId;
    state.factoryValidationStatus =
      factoryValidationGateResolution.factoryValidationStatus;
    state.validationGateCount =
      factoryValidationGateResolution.validationGateCount;
    ...
    state.productionBatchId =
      batchOrchestrationAuditTrailResolution.productionBatchId;
    state.auditTrailId = batchOrchestrationAuditTrailResolution.auditTrailId;
    state.batchAssetCount =
      batchOrchestrationAuditTrailResolution.batchAssetCount;
    state.batchDependencyCount =
      batchOrchestrationAuditTrailResolution.batchDependencyCount;
    state.orchestrationReason =
      batchOrchestrationAuditTrailResolution.orchestrationReason;
    ...
    assetFactoryManifestDecisions.push(
      deepFreeze({
        featureId: feature.featureId,
        assetPackageManifestId:
          assetFactoryManifestResolution.assetPackageManifestId,
    ...
    factoryValidationGateDecisions.push(
      deepFreeze({
        featureId: feature.featureId,
        productionReadinessProfileId:
          factoryValidationGateResolution.productionReadinessProfileId,
    ...
    batchOrchestrationAuditTrailDecisions.push(
      deepFreeze({
        featureId: feature.featureId,
        productionBatchId:
          batchOrchestrationAuditTrailResolution.productionBatchId,
        auditTrailId: batchOrchestrationAuditTrailResolution.auditTrailId,
        batchAssetCount:
          batchOrchestrationAuditTrailResolution.batchAssetCount,
        batchDependencyCount:
          batchOrchestrationAuditTrailResolution.batchDependencyCount,
      ...
      resolvedFeatureRecipes.push(
        deepFreeze({
          ...
          productionBatchId:
            batchOrchestrationAuditTrailResolution.productionBatchId,
          auditTrailId:
            batchOrchestrationAuditTrailResolution.auditTrailId,
          batchAssetCount:
            batchOrchestrationAuditTrailResolution.batchAssetCount,
          batchDependencyCount:
            batchOrchestrationAuditTrailResolution.batchDependencyCount,
    ...
    for (const placement of contextualWorldFillResolution.placements) {
      ...
      candidateEntries.push({
        ...
        batchAssetCount: 0,
        batchDependencyCount: 0,
        orchestrationReason: "PENDING_BATCH_ORCHESTRATION_AUDIT_TRAIL",
        microClusterId: null,
        clusterType: null,
        childAssetCount: 0,
        adjacencyReason: null,
  ...
  for (const candidate of candidateEntries) {
    ...
    const assetFactoryManifestCandidateResolution =
    ...
    const factoryValidationGateCandidateResolution =
    ...
    const batchOrchestrationAuditTrailCandidateResolution =
    ...
    if (modularCandidateBindingResolution.matched) {
      ...
      state.exportValidationProfileId =
        assetFactoryManifestCandidateResolution.exportValidationProfileId;
      state.manifestComponentCount =
        assetFactoryManifestCandidateResolution.manifestComponentCount;
      state.manifestValidationStatus =
      ...
      state.factoryValidationStatus =
        factoryValidationGateCandidateResolution.factoryValidationStatus;
      state.validationGateCount =
        factoryValidationGateCandidateResolution.validationGateCount;
      state.passedGateCount =
      ...
      state.productionBatchId =
        batchOrchestrationAuditTrailCandidateResolution.productionBatchId;
      state.auditTrailId =
        batchOrchestrationAuditTrailCandidateResolution.auditTrailId;
      state.batchAssetCount =
        batchOrchestrationAuditTrailCandidateResolution.batchAssetCount;
      state.batchDependencyCount =
        batchOrchestrationAuditTrailCandidateResolution.batchDependencyCount;
      state.orchestrationReason =
        batchOrchestrationAuditTrailCandidateResolution.orchestrationReason;
    }
  ...
  const plan = deepFreeze({
    ...
    batchOrchestrationAuditTrailDecisions: deepFreeze(
      batchOrchestrationAuditTrailDecisions
    ),
...
export function getDeveloperOnlyAtlasWorldPopulationPlannerStatus(planner) {
  if (
    ...
    return freezeStatus({
      ...
      atlasAssetFactoryPackageManifestsVersion: null,
      registeredAssetFactoryManifestRuleCount: 0,
      assetPackageManifestId: null,
      exportValidationProfileId: null,
      manifestComponentCount: 0,
      ...
      atlasFactoryValidationGatesVersion: null,
      registeredFactoryValidationGateRuleCount: 0,
      productionReadinessProfileId: null,
      ...
      atlasBatchOrchestrationAuditTrailsVersion: null,
      registeredBatchOrchestrationRuleCount: 0,
      productionBatchId: null,
      auditTrailId: null,
      batchAssetCount: 0,
      batchDependencyCount: 0,
