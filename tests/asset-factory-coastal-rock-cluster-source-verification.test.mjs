...
test("rock cluster v001 source verification records the canonical source facts", () => {
...
test("rock cluster v001 source verification records the current Blender runtime export blocker", () => {
  const sourceVerification = JSON.parse(fs.readFileSync(sourceVerificationPath, "utf8"));
