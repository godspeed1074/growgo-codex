...
test("phase 211.50x cache bust wires the development alpha module entry through a versioned URL", () => {
  assert.match(
    indexSource,
...
test("phase 211.50x cache bust wires the live one-frame adapter import through a versioned URL", () => {
  assert.match(
